...
<!---
amren11/amren11 is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "ymenii")}}}
local Sudo_Welcome = '⌯︙يمكنك ايضا استخدام الاوامر الخدميه \n⌯︙اليك ازرار الاوامر الخدميه اسفل الرساله\n                  • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n                              [𝐅𝐀𝐄𝐃𝐄𝐑 - 𝐂𝐇](https://t.me/ymenii)'
local key = {
{'زخرفه','احسب عمرك'},
{'الابراج','نسبه الحب'},
{'قسم الحمايه'},
...
local text = text:gsub('user',(result.username_ or 'ymenii'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end 
...
local text = text:gsub('user',(msg.content_.members_[0].username_ or 'ymenii'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
--     By Developer Faeder     -- 
-------- Contact
...
local text = text:gsub('username',(result.username_ or 'ymenii'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end 
...
local inline = {
{{text="- قناة السورس ،",url="t.me/ymenii"},
{text="- مبرمج السورس،",url="t.me/ymenii"}},
{{text="- اضغط هنا لتنصيب السورس ،",url="t.me/ymenii"}},
{{text="- كروب المبرمجين ،",url="https://t.me/joinchat/TXKJWVCCy9FF6g6cjajRGA"},
{text="- شروحات السورس ،",url="t.me/ymenii"}}
}
...
faederdx1:set(FAEDER.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "@ymenii")) 
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙المنشئ ⌯» ["..monsh.."]\n\n⌯︙الرابط ، ["..title_name(chattid).."]("..(t2.invite_link_ or "t.me/ymenii")..")\n⌯︙ايديها ⌯» *"..msg.chat_id_.."*\n⌯︙عدد الاعضاء ⌯» *"..data.member_count_.."* \n⌯︙عدد المدراء ⌯» *"..Owner.."*\n⌯︙عدد المنشئين ⌯» *"..Monsh.."*\n⌯︙عدد الادمنيه ⌯» *"..Momod.."*\n⌯︙عدد المكتومين ⌯» *"..Muted.."*\n⌯︙عدد المحظورين ⌯» *"..Baned.."*\n⌯︙عدد المقيدين ⌯» *"..Tkeed.."*\n⌯︙عدد المميزين ⌯» *"..Vip.."*\n", 1,"md")
end
tdcli_function ({
ID = "GetChannelFull",
...
local list = faederdx1:smembers(FAEDER.."bot:groups")
local text = "~ Groups_Bots_In_the_Bot_Of_Source_Faeder ~ @ymenii\n\n"
for k,v in pairs(list) do
